export default class Text {
  constructor(object , x, y, width, height, quote, offset) {
    ...
    var content = object.add.text(0, 0, quote, { fontFamily: 'RetroscapeRegular', fontSize: 14, color: '#000000', align: 'center', wordWrap: { width: bubbleWidth - (bubblePadding * 2) } });
